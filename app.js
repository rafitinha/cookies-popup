...
const element = document.getElementsByClassName('cookie-container');

button.addEventListener('click', () =>{
    gsap.to('.cookie-container',{opacity:0,y:100, duration:0.75, ease:"power1.out",onComplete:function(){
        //console.log(this);
        element[0].remove();
    }});
})